...
namespace aligment
{
    void start()
    {
         ...
         */
        {
            ...
            /*
             8 Способ: отключение выравнивания с помощью макроса #pragma pack (push, 1), 1 - устанавливает размер выравнивания в байтах.
...
#pragma pack (pop)
            ...
            /*
             Плотная упаковка полей - опуститься до уровней битов.
             Плюсы: уменьшение потребляемой памяти.
             Минусы: уменьшение скорости работы.
             */
            {
